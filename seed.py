...
s1 = Student(id=1001, email="student1001@schoolemail.com", password="$2b$12$N8NwfZuxeemu0iJ.1vnYMeiEicrnJjVDnoOESo7sUCzfKs925IwdS", first_name="John", last_name="Jenkins", grade="9")
...
sa2 = StudentAssignment(student_id=1001, assignment_id=2, score=71, passed=True)
sa3 = StudentAssignment(student_id=1002, assignment_id=1, score=56, passed=False)
sa4 = StudentAssignment(student_id=1002, assignment_id=3, score=98, passed=True)
sa5 = StudentAssignment(student_id=1001, assignment_id=4, score=34, passed=False)
